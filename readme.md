# Simple E-Commerce Node.js Backend API

## Introduction
This is simple Ecommerce api
## Run
...
You can use the following url, but you need to get your `username`, `password` and `dbname` which you created in your database, based on how it's explained in the course.
